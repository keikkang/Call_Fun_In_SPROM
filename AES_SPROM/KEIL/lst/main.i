...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(12UL<<0)));
...
int main()
{
    ...
    ((((CRPT_T *) (0x50080000UL)))->INTEN |= ((0x1ul << (0))|(0x1ul << (1))));
    ...
    while (1)
    {
       ...
       if (((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPSTS & (0x1ul << (31)))
            printf("ISPSTS=0x%x, SPROM is secured.\n", ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPSTS);
       else
