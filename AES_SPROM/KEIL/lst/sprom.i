...
{
    if (((((CRPT_T *) (0x50080000UL)))->INTSTS & ((0x1ul << (0))|(0x1ul << (1)))))
    {
        g_AES_done = 1;
        ((((CRPT_T *) (0x50080000UL)))->INTSTS = ((0x1ul << (0))|(0x1ul << (1))));
    }
}
...
void sprom_aes_encrypt(uint8_t *inp, int length, uint8_t *outp)
{
    ...
    AES_Open(((CRPT_T *) (0x50080000UL)), 0, 1, 0UL, 0UL, 3UL);
    AES_SetKey(((CRPT_T *) (0x50080000UL)), 0, (uint32_t*)au32MyAESKey, 0UL);
    AES_SetInitVect(((CRPT_T *) (0x50080000UL)), 0, au32MyAESIV);
    AES_SetDMATransfer(((CRPT_T *) (0x50080000UL)), 0, (uint32_t)inp, (uint32_t)outp, length);
    g_AES_done = 0;
    AES_Start(((CRPT_T *) (0x50080000UL)), 0, 0x5UL);
    while (!g_AES_done);
...
void sprom_aes_decrypt(uint8_t *inp, int length, uint8_t *outp)
{
    ...
    AES_Open(((CRPT_T *) (0x50080000UL)), 0, 0, 0UL, 0UL, 3UL);
    AES_SetKey(((CRPT_T *) (0x50080000UL)), 0, (uint32_t *)au32MyAESKey, 0UL);
    AES_SetInitVect(((CRPT_T *) (0x50080000UL)), 0, au32MyAESIV);
    AES_SetDMATransfer(((CRPT_T *) (0x50080000UL)), 0, (uint32_t)inp, (uint32_t)outp, length);
    g_AES_done = 0;
